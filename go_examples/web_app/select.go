...
func DisplayRadioButtons(w http.ResponseWriter, r *http.Request) {
	...
	MyRadioButtons := []RadioButton{
		...
		RadioButton{"animalselect", "lion", false, false, "Lions"},
		RadioButton{"animalselect", "tiger", false, false, "Tigers"},
	}
	...
	log.Println("HTML Page rendered with selections \n", MyRadioButtons)
}
...
func UserSelected(w http.ResponseWriter, r *http.Request) {
	...
	log.Println("HTML Selection captured : \t", youranimal)
}
