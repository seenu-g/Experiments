...
contract InternContract {
    ...
    function getProfileData (string pan) public view returns (string name, string phone, string email) {
    ...
    function getInterviewResult(string pan) public view  returns(string duration, uint16 stipend){
