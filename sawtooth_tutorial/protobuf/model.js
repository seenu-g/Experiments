...
$root.model = (function() {
    ...
    model.Collection = (function() {
         ...
         * @property {number|Long|null} [createdTsMicros] Collection createdTsMicros
         * @property {Array.<string>|null} [subscriberIds] Collection subscriberIds
         * @property {Array.<string>|null} [items] Collection items
         */
    ...
    model.Item = (function() {
         ...
         * @property {string|null} [url] Item url
         * @property {number|Long|null} [createdTsMicros] Item createdTsMicros
         * @property {string|null} [authorId] Item authorId
         */
