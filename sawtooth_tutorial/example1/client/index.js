...
const argv = require('yargs')
  .usage('Usage: node $0 --name [string] --verb [set,inc,dec,get] --value [integer]')
  .choices('verb', ['set', 'inc', 'dec','get'])
  .number('value')
  .string(['verb', 'name'])
  ...
  .example('node index.js --name foo --verb get --value ?', 'If `foo` is defined, get value')
  .wrap(null)
